# trader_core.py - هسته ربات بدون Streamlit
import pandas as pd
import numpy as np
import requests
import time
...
try:
    ...
    try:
        import matplotlib
        matplotlib.use('Agg')  # برای سرور بدون نمایش
        import matplotlib.pyplot as plt
        MATPLOTLIB_AVAILABLE = True
        print("✅ Using matplotlib as fallback")
    except ImportError:
        MATPLOTLIB_AVAILABLE = False
        print("⚠️ Matplotlib also not available")

# ایجاد توابع جایگزین اگر plotly نباشد
if not PLOTLY_AVAILABLE:
    # توابع dummy برای جلوگیری از خطا
    class DummyFigure:
        ...
        def show(self, *args, **kwargs):
            print("Plotly not available - chart display disabled")
...
SYMBOLS = [
    ...
    "SOLUSDT", "DOGEUSDT", "ADAUSDT", "AVAXUSDT", "MATICUSDT",
    "NEARUSDT", "APTUSDT", "ARBUSDT", "OPUSDT", "RNDRUSDT"
]
